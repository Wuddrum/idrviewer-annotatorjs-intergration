...
(function() {
    ...
    IDRViewerController.initialize_fullscreen = function() {
        var Fullscreen = {
        ...
        ["fullscreenchange", "MSFullscreenChange", "mozfullscreenchange", "webkitfullscreenchange"].forEach(function(type) {
            document.addEventListener(type, fullscreenChangeHandler);
        });
    };
    
    IDRViewerController.destroy_fullscreen = function() {
        ["fullscreenchange", "MSFullscreenChange", "mozfullscreenchange", "webkitfullscreenchange"].forEach(function(type) {
            document.removeEventListener(type, fullscreenChangeHandler);
        });
    };
